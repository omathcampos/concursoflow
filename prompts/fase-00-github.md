...
6. **Templates**: `.github/pull_request_template.md` (O que foi feito / Fase relacionada / Checklist: critérios de aceite da fase, `npm run lint` limpo, tsc sem erros, testes unit e e2e verdes, testado localmente, "se há migration nova, MIGRATIONS.md atualizado") e `CONTRIBUTING.md` com o fluxo acima.
